#ifndef PROXSUITE_SOLVERS_UTILS_RANDOM_QP_PROBLEMS_HPP
#define PROXSUITE_SOLVERS_UTILS_RANDOM_QP_PROBLEMS_HPP
...
#endif /* end of include guard PROXSUITE_SOLVERS_UTILS_RANDOM_QP_PROBLEMS_HPP   \
        */
