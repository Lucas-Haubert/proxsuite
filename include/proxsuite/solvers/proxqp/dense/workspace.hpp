 ...
 * @file workspace.hpp
 */
#ifndef PROXSUITE_SOLVERS_PROXQP_DENSE_WORKSPACE_HPP
#define PROXSUITE_SOLVERS_PROXQP_DENSE_WORKSPACE_HPP

#include <Eigen/Core>
#include <proxsuite/linalg/dense/ldlt.hpp>
#include <proxsuite/solvers/timings.hpp>
#include <proxsuite/linalg/veg/vec.hpp>
#include <proxsuite/solvers/settings.hpp>
#include <proxsuite/solvers/common_dense/fwd.hpp> // Added to recognize the Mat and Vec types (dense)
namespace proxsuite {
namespace proxqp {
namespace dense {
///
...
#endif /* end of include guard PROXSUITE_SOLVERS_PROXQP_DENSE_WORKSPACE_HPP */
