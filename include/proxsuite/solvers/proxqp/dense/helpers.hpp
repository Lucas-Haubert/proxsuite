...
#ifndef PROXSUITE_SOLVERS_PROXQP_DENSE_HELPERS_HPP
#define PROXSUITE_SOLVERS_PROXQP_DENSE_HELPERS_HPP

#include <proxsuite/solvers/results.hpp>
#include <proxsuite/solvers//settings.hpp>
#include <proxsuite/solvers/status.hpp>
#include <proxsuite/solvers/common_dense/fwd.hpp>
#include <proxsuite/solvers/common_dense/preconditioner/ruiz.hpp>
#include <proxsuite/solvers/proxqp/dense/workspace.hpp> // Added to recognize the Workspace struct
#include <proxsuite/solvers/proxqp/dense/model.hpp> // Added to recognize the Model struct
#include <chrono>
...
#endif /* end of include guard PROXSUITE_SOLVERS_PROXQP_DENSE_HELPERS_HPP */
